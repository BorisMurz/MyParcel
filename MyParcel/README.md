...
Веб-приложение для загрузки PDF СРЗУ, распознавания координат, пересчета в WGS84, проверки топокорректности и отображения объекта на карте. Подробную инструкцию по развертыванию можно найти внутри репозитория с приложением
